...
class Nomura:
    ...
    def balance_certificate(self):
        ...
        pdf.draw_string(57, 64, '代理人　行政書士法人チェスター　代表社員　清水　茜作', 6)
        pdf.draw_string(67, 74, f'ﾋｿｳｿﾞｸﾆﾝ {mojimoji.zen_to_han(jaconv.hira2kata(self.customer_name_kana))} ｿｳｿﾞｸﾆﾝ {mojimoji.zen_to_han(jaconv.hira2kata(self.heir_name_kana))}', 5)
        pdf.draw_string(67, 71.5, 'ﾀﾞｲﾘﾆﾝ ｷﾞｮｳｾｲｼｮｼﾎｳｼﾞﾝﾁｪｽﾀｰ ﾀﾞｲﾋｮｳｼｬｲﾝ ｼﾐｽﾞｾﾝｻｸ', 5)
